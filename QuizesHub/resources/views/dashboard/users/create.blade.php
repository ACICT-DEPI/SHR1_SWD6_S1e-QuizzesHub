        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.users.store') }}" enctype="multipart/form-data"
                        method="post">
                        @csrf
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="menu-icon fa fa-book"></i></div>
                                    <input type="file" id="image_path" value="{{ old('image_path') }}"
